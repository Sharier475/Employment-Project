...
public class StateRepository : Repository<State>, IStateRepository
{
    ...
    public StateRepository(IHttpClientFactory httpClientFactory, string endpoint="State") : base(httpClientFactory, endpoint)=>_httpClient = httpClientFactory.CreateClient("EmployeeApi");
